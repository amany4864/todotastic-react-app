    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-100 mb-4 sm:mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
            {user ? (
              <Link
                to="/dashboard"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl text-base sm:text-lg font-semibold"
              >
                Go to Dashboard
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 border-2 border-gray-600 text-gray-300 rounded-xl hover:border-gray-500 hover:text-white transition-all duration-200 text-base sm:text-lg font-semibold"
                >
                  Sign In
                </Link>
              </>
        ...
        {/* Features */}
        <div className="mt-16 sm:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 px-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700/50">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-3 sm:mb-4">Smart Task Management</h3>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700/50">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-3 sm:mb-4">Daily Planning</h3>
            <p className="text-sm sm:text-base text-gray-400">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700/50">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-3 sm:mb-4">Goal Tracking</h3>
            <p className="text-sm sm:text-base text-gray-400">
